...
public class CustomerBeanTest {
	...
	public static JavaArchive createDeployment() {
		return ShrinkWrap.create(JavaArchive.class).addClass(CustomerBean.class).addClass(Customer.class)
				.addClass(Address.class).addClass(Country.class).addClass(ValidationException.class)
	...
	public void should_paginate() {
		...
		assertTrue((customerbean.getPageItems().size() == customerbean.getPageSize())
				|| (customerbean.getPageItems().size() == customerbean.getCount()));
	}
}
