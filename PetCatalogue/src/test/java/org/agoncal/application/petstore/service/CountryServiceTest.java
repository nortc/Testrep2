...
public class CountryServiceTest {
	...
	public static JavaArchive createDeployment() {
		return ShrinkWrap.create(JavaArchive.class).addClass(AbstractService.class).addClass(CountryService.class)
				.addClass(Country.class).addAsManifestResource("META-INF/persistence.xml", "persistence.xml")
